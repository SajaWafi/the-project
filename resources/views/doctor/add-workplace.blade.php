    ...
    <style>
        ...
        * {
        ...
        .days-bar {
            ...
            gap: 8px;
            margin-bottom: 18px;
            direction: ltr; /* 💡 الحفاظ على ترتيب الأيام */
        }
    ...
    <div class="phone">
        <div class="content">
            ...
            <div class="header">
                ...
                <div class="page-title">{{ __('Add Workplace') }}</div>
            ...
            <form action="{{ route('doctor.add.workplace.store') }}" method="POST">
                @csrf
                ...
                <div class="form-wrap">
                                ...
                                <select name="from_hour" class="time-select">
                                    @for ($i = 1; $i <= 12; $i++)
                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}"
                                            {{ old('from_hour', '08') == str_pad($i, 2, '0', STR_PAD_LEFT) ? 'selected' : '' }}>
                            ...
                            <div class="time-select-wrap">
                                <select name="from_minute" class="time-select">
                                    @foreach (['00','15','30','45'] as $minute)
                                        <option value="{{ $minute }}"
                                            {{ old('from_minute', '30') == $minute ? 'selected' : '' }}>
                                            {{ $minute }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="time-row">
                            <div class="time-select-wrap">
                                <select name="to_hour" class="time-select">
                                    @for ($i = 1; $i <= 12; $i++)
                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}"
                                            {{ old('to_hour', '10') == str_pad($i, 2, '0', STR_PAD_LEFT) ? 'selected' : '' }}>
                                            {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}
                                        </option>
                                    @endfor
                                </select>
                            ...
                            <div class="time-select-wrap">
                                <select name="to_minute" class="time-select">
                                    @foreach (['00','15','30','45'] as $minute)
                                        <option value="{{ $minute }}"
                                            {{ old('to_minute', '00') == $minute ? 'selected' : '' }}>
                                            {{ $minute }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="actions">
                        <button type="submit" class="primary-btn">{{ __('Add new workplace') }}</button>
