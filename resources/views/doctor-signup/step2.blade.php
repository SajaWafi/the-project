    ...
    <form action="{{ route('doctor.step2.post') }}" method="POST" style="display:flex; flex-direction:column; height:100%;">
        ...
        <div class="field">
            ...
            <div class="input-wrap">
                <input class="input password-input" id="password" type="password" name="password" value="{{ old('password', session('doctor_signup.password')) }}">
        ...
        <div class="field">
            ...
            <div class="input-wrap">
                <input class="input password-input" id="password_confirmation" type="password" name="password_confirmation" value="{{ old('password_confirmation') }}">
